create a script command that handles all the project  "Requirements
Python Scripts
...
GitHub repository: alx-backend-user-data
Directory: 0x01-Basic_authentication
File: api/v1/auth/auth.py"  " from beginning to end, save it as setup1.sh so that when i run the setup1.sh script the whole files should be created with the solutions and the also execute the commands